                ...
                children: <Widget>[
                  ...
                  Card(
                    elevation: 1,
                      child: ListTile(
                      //contentPadding: EdgeInsets.all(10.0),
                      title: Text("Log Out",style: TextStyle(fontFamily: 'Work_Sans',fontSize: 20,fontWeight: FontWeight.w600),
                      textAlign: TextAlign.center,),
                      onTap: (){
                        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_)=>AllUsersScreen()));
                      },
                    ),
                  ),
                ],
